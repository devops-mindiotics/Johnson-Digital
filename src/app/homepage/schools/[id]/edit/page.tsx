...
// ===== Build-time data =====
const MOCK_IDS = ["sch_1"]; // add every school id you want exported
const MOCK_SCHOOLS: Record<string, any> = {
  sch_1: {
    id: "sch_1",
...
const MOCK_SCHOOL_LIST = [
  { id: "sch_2", schoolName: "Oakridge International School", johnsonSchoolId: "JSN-124" },
  { id: "sch_3", schoolName: "Delhi Public School",          johnsonSchoolId: "JSN-125" },
  { id: "sch_4", schoolName: "National Public School",        johnsonSchoolId: "JSN-126" },
];

// Required for static export of a dynamic segment
...
export default async function Page({ params }: { params: { id: string } }) {
  const initial = MOCK_SCHOOLS[params.id];
  if (!initial) return notFound();

  const EditSchoolClient = (await import("./EditSchoolClient")).default;
  return <EditSchoolClient initialSchool={initial} schoolList={MOCK_SCHOOL_LIST} />;
}
